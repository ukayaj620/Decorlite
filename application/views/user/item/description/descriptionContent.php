		...
		<div class="col-10 col-md-4 py-md-4 d-flex flex-column justify-content-md-between align-items-center align-items-md-start">
			...
			<div class="d-flex flex-column flex-md-row align-items-center my-4">
				<div class="d-flex flex-row align-items-center">
					...
					<div id="item-count" class="h4 h3-md m-0">1</div>
					<button onclick="handleIncrease()" type="button" class="btn btn-warning mx-2" style="width: 40px;">+</button>
				</div>
				<a href="<?= base_url('cart/addItemToCart/'.$itemData->itemId.'/1') ?>" id="add-to-cart" class="btn btn-warning ml-md-4 px-5 mt-3 mt-md-0">Tambah ke Keranjang</a>
			</div>
		</div>
	</div>
...
<script>
	...
	const setHref = newValue => button.href = '<?= base_url('cart/addItemToCart/'.$itemData->itemId.'/') ?>' + newValue;
