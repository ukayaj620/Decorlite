...
<body>
  ...
  <main role="main">
    <div id="carouselExampleIndicator" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="index.svg" alt="First slide">
        </div>
        <div class="carousel-item">
          <img class="d-block w-100" src="index2.svg" alt="Second slide">
        </div>
        <div class="carousel-item">
          <img class="d-block w-100" src="index3.svg" alt="Third slide">
        </div>
      </div>
    ...
    <div class="container py-4">
      <div class="row py-4">
        <div class="col-3">
          <a class="my-2" href="" target="_blank">
            <div class="card card-hover bg-light text-white">
              <img class="card-img" src="" width=200px height=200px/>
              <div class="card-img-overlay d-flex flex-column justify-content-end">
                <p class="card-text text-truncate text-center">Flowers</p>
              </div>
            </div>
          </a>
        </div>
